...
$app['main_menu'] = function($app) {
    ...
    $tours->addChild('Trip calendar', array('route' => 'page_show', 'routeParameters' => array('slug' => 'trip-calendar-2014')))->setLabel('<i class="icon-caret-right"></i> Trip Calendar')->setExtra('safe_label', true)->setCurrentUri($uri);
